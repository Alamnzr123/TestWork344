...
Tags:shipping cities,cities shipping,shipping rate,woocommerce shipping,custom shipping
...
Bug Fix: Resolved an issue where the default shipping rate for cities not explicitly listed was not being applied correctly.
 This update ensures that the default rate is used when no specific rate is defined for a city.

Minor fixes for improved plugin stability and compatibility.

= 1.1.0 =

Fixed an issue where the import cities option was not functioning properly, preventing CSV files from being uploaded successfully.
Improved error handling for invalid or incorrectly formatted CSV files during import.
Enhanced user feedback on the import/export process to provide better clarity on successful or failed actions.
Minor UI/UX improvements in the plugin's settings page for a better user experience.

= 1.0.0 =

* Initial release of Shippping Rate By Cities.
